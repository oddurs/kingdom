...
// `.welcome` — the first-run overlay card. Carries the large brand mark and
// the primary/secondary call to action. Rendered as just the `.card` here
// (the full overlay dims the whole screen).
export default {
  title: 'Components/Welcome',
  parameters: { layout: 'centered', backgrounds: { default: 'ground-2' } },
};

const MARK = `<svg width="0" height="0" style="position:absolute" aria-hidden="true"><symbol id="ygg-mark-sb" viewBox="0 0 40 40">
