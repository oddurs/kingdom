import{e as y}from"./_util-BTFOiCfg.js";const k={title:"Components/Specimen panel",parameters:{layout:"centered"}},d=(a,r)=>{const s=y(`<aside class="panel" role="dialog" aria-label="Taxon detail">${r}</aside>`);return s.style.cssText+=`position:static;opacity:1;transform:none;max-height:none;width:330px;--lc:${a};border-left-color:${a};border-top-color:${a}`,s},u=({crumb:a,rank:r,name:s,common:b,blurb:f,examples:h,stats:g})=>`
  ...
  <span class="prank" style="background:var(--lc)">${r}</span>
  <h2 class="pname">${s}</h2>
  <div class="pcommon">${b}</div>
  <p class="pblurb">${f}</p>
  <div class="pexlabel">Examples</div>
  <div class="pex">${h.map(e=>`<span class="exchip">${e}</span>`).join("")}</div>
...
}))`,...(l=(o=t.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};var i,p,m;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`() => card('#8f9be8', body({
...
}))`,...(m=(p=n.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};const A=["Cactaceae","Asteraceae"];export{n as Asteraceae,t as Cactaceae,A as __namedExportsOrder,k as default};
