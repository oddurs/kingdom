import{e as b}from"./_util-BTFOiCfg.js";const g={title:"Components/Timebar",parameters:{layout:"centered",backgrounds:{default:"ground"}}},m=[["Silurian",444,419,"#4f8f79"],["Devonian",419,359,"#3f7f88"],["Carboniferous",359,299,"#566f9e"],["Permian",299,252,"#8a6cae"],["Triassic",252,201,"#a76aa0"],["Jurassic",201,145,"#c17f68"],["Cretaceous",145,66,"#8faa55"],["Paleogene",66,23,"#d3a24a"],["Neogene",23,2.6,"#dcc06a"],["Quaternary",2.6,0,"#c9c9c9"]],e=445,t=a=>(e-a)/e*100,v=m.map(([,a,p,u])=>`<span class="bd" style="left:${t(a).toFixed(1)}%;width:${(t(p)-t(a)).toFixed(1)}%;background:${u}"></span>`).join(""),s=()=>{const a=t(139);return b(`<div class="timebar" style="position:static;width:min(680px,90vw)">
  ...
  </div>`)},i=()=>b(`<div class="timebar" style="position:static;width:min(680px,90vw)">
    <div class="tbhint">Drag back through <b>445 million years</b> — each lineage appears at its origin</div>
    <div class="tbrow">
      <button class="tbplay" aria-label="Play through time">&#9654;</button>
  ...
  </div>`);var n,r,l;s.parameters={...s.parameters,docs:{...(n=s.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
...
}`,...(l=(r=s.parameters)==null?void 0:r.docs)==null?void 0:l.source}}};var o,c,d;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`() => el(\`<div class="timebar" style="position:static;width:min(680px,90vw)">
    <div class="tbhint">Drag back through <b>445 million years</b> — each lineage appears at its origin</div>
    <div class="tbrow">
      <button class="tbplay" aria-label="Play through time">&#9654;</button>
      <div class="tbtrack" role="slider" aria-valuemin="0" aria-valuemax="445" aria-valuenow="0">
  ...
  </div>\`)`,...(d=(c=i.parameters)==null?void 0:c.docs)==null?void 0:d.source}}};const y=["Playing","PresentDay"];export{s as Playing,i as PresentDay,y as __namedExportsOrder,g as default};
